    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.Result) {
                ...
                $("#login_boxs").hide();
                if ($("#view_soon_lists_show").css("display") == "block") {
                    $("#view_soon_lists_show").show();
                }
                $("#Favorites_lists_show .go_order_box").stop().animate({
                    right: 0
                }, 400);
        ...
        $.each(jn.SellerCart, function (i, o) {
            ...
            $.each(cartList, function (i, ent) {
                ...
                if (ent.BuyType == 0 && sku) {
                    ...
                    $.each(sku, function (i, sub) {
                        if (sub.DetailType != 4) {
                            //DetailType 商品类型 1-普通订购 2-赠品 3-换购商品 4-搭配商品 5-限时限量 6-秒杀商品
            ...
            if (o.SellerCode == kadSellerCode) {
                ...
                if (rxStr != "") {
                    ...
                    htmlStr += couponList + '<p class="total_prices">新特药房先烈店  <span class="price_num"> 合计：' + ToMoney(rxTotal - couponPrice) + '</span></p>';
                }
            } else {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data) {
                    ...
                    setTimeout(function () {
                        $("#scrollBar2 .favor_success").hide().text("删除失败,请重试！");
                    }, 2000);
                }
            }
        });
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.length >= 1) {
                ...
                $("#go_buyAgain .go_order_box").stop().animate({
                    "right": 0
                }, 400);
                if ($("#go_buyAgain").css("display") == "none") {
                    $("#go_buyAgain .go_order_box").stop().animate({
                        "right": - 264
                    }, 400);
                }
...
(function () {
    $(function () {
        ...
        if ($windowH > 700) {
            $(".navi_left").css("padding-top", 200);
            $(".sm_two_order").css("margin-top", 20);
        }
        if ($windowH < 800) {
            $(".navi_left").css("padding-top", 150);
            $(".sm_two_order").css("margin-top", 20);
        }
        ...
        $(".my_Info").bind('click', function (event) {
            ...
            if ($my_Info_isLogin.eq(_this).css('display') == "none") {
                ...
                $fixed_navigation.stop().animate({
                    "right": 0
                }, 400);
                $go_order_box.eq(_this).stop().animate({
                    "right": 0
                }, 400);
            ...
            switch (_this) {
                case 2:
                    if ($('.isbd_mobile').css("display") == "none") {
                        $(this).children(".my_Info_container").stop().animate({
                            right: "36px",
                            opacity: 1
                        }, 400).show();
                        $(this).children(".pointer").stop().animate({
                            right: "30px",
                            opacity: 1
                        }, 400).show();
                    }
                ...
                case 4:
                    ...
                    $(this).children(".Favorites_container").stop().animate({
                        right: "36px",
                        opacity: 1
                    }, 400).show();
                    $(this).children(".pointer").stop().animate({
                ...
                case 5:
                    ...
                    $(this).children(".view_soon_container").stop().animate({
                        right: "36px",
                        opacity: 1
                    }, 400).show();
                    $(this).children(".pointer").stop().animate({
                ...
                case 6:
                    ...
                    $(this).children(".order_current_container").stop().animate({
                        right: "36px",
                        opacity: 1
                    }, 400).show();
                    $(this).children(".pointer").stop().animate({
