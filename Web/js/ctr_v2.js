...
function domReady(){
    ...
    if (document.addEventListener) {		//��IE8�����°汾
...
function ctr_v2(event,act) {
    ...
    function a(e) {						//�½�image����,ͨ������image src�ķ�ʽ����ƴ�Ӻõ���Ϣ����������
        var t = new Image(1, 1);
        //alert(e);
        t.src = e
    }
    ...
    if(act==undefined||act==""){
        a(f(o("__juid")))					//ˢ��ҳ�����÷���,������action��Ϊ����
    }
    else{
        a(f(o("__juid")) + "&action=" + t(act))
    }

    ctrActionsend = function() {		//�����¼������÷�������action��Ϊ
...
function getElementsByClassName(className,tagName) { 		//����IE�Ͱ汾getElementsByClassName����
    tagName=tagName||"*";                                    //����tagName���Բ�д��
    if (document.getElementsByClassName) {                    //����������֧��getElementsByClassName��ֱ����
        return document.getElementsByClassName(className);
    }/*else {
     var tag= document.getElementsByTagName(tagName);    //��ȡָ��Ԫ��
     var tagAll = [];                                    //���ڴ洢����������Ԫ��
     for (var i = 0; i < tag.length; i++) {                //�������õ�Ԫ��
     for(var j=0,n=tag[i].className.split(' ');j<n.length;j++){    //������Ԫ��������class��ֵ,��������ָ��������,�͸�ֵ��tagnameAll
     if(n[j]==className){
     tagAll.push(tag[i]);
     break;
     }
